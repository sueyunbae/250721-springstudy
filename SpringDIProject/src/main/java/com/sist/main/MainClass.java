 ...
 * 		***webApplicatioinContext : core => AOP (공통모듈) + MVC
 * 
 * 	=> 주입 => 생성 / 소멸 관리 한다
 ...
 * 	2) Bean 생성(클래서 객체 생성)
 * 		<bean id="a" class="패키지명.클래스명">
 * 		=> map.put("a", Class.forName());
 * 		<bean id="b" class="패키지명.클래스명">
 * 		=> map.put("b", Class.forName());
 * 		<bean id="c" class="패키지명.클래스명">
 * 		=> map.put("c", Class.forName());
 * 
 * 		-------------------
 * 		   a   new A()
 * 		-------------------
